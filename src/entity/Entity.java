...
public abstract class Entity {
    ...
    public boolean isTileLeftKlicked() {
    ...
    public boolean isTileRightKlicked() {
    ...
    public boolean isLeftKlicked() {
        if (Mouse.getMouseReleasedLeftX() >= getPosX() && Mouse.getMouseReleasedLeftX() <= getPosX() + getWight() && Mouse.getMouseReleasedLeftY() >= getPosY() && Mouse.getMouseReleasedLeftY() <= getPosY() + getHeight()) {
            Mouse.resetMouse();
            return true;
        } else {
            return false;
    ...
    public boolean isRightKlicked() {
        if (Mouse.getMouseReleasedRightX() >= getPosX() && Mouse.getMouseReleasedRightX() <= getPosX() + getWight() && Mouse.getMouseReleasedRightY() >= getPosY() && Mouse.getMouseReleasedRightY() <= getPosY() + getHeight()) {
            Mouse.resetMouse();
            return true;
        } else {
            return false;
